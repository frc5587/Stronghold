...
/**
 * The motor, encoder, and limit switch used in the locomotion of the
 * launching mechanism on Caligula.
 */
public class StrongArm extends PIDSubsystem {
    ...
    private final VictorSP motor = new VictorSP( RobotMap.STRONG_ARM );
    private final DigitalInput top = new DigitalInput( RobotMap.TOP_LIMIT );
